...
const Form = () => {
  return (
    <div className='container'>
      <div  style = {{backgroundColor:'skyblue',textAlign:'left'}} className='title'>
        <h1 style = {{margin:'0'}}>Disseration Research Travel Award Aplication</h1>
      ...
      <div className='horizontal-1'>
        ...
        {/* <div> */}
          ...
          <input  className = 'form-input' type="text"name =  '' value = "" required/>
          </div>
          <div>
          ...
          <textarea  className = 'form-input' type="text"name =  '' value = "" textarea/>
          </div>
          <div>
          ...
          <h2 style ={{textAlign:'left', marginBottom:'0', paddingTop:'0', margin:'0'}}>Expense Information:</h2>
          <p>(Transportation, Lodging, Conference,Registration Only - Actual or Estimated)</p>
          <div>
          <p className='para'>Subject of your research: </p>
          ...
          <textarea  className = 'form-input' type="textarea"name =  '' value = "" />
          </div>
          <div>
          ...
          <div>
          <p className = 'para'>I have applied to another organization fro funding</p>
          ...
          <div>
            <p  style  = {{width:'100'}}className='para'>Funding received?</p>
